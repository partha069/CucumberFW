Feature: As a user, I should be able to view Blogs to see list of articles related to it
  ...
  @regression @smoke @stateLawDetail_smoke_mob
...
Scenario: To verify User should be able to view a Hero section of the Benefits of Cannabis Article Details page
  ...
  @regression @stateLawDetail_smoke @stateLawDetail_smoke_mob
...
Scenario: To verify user is able to view “New” tag for the article which has less than or equal to 15 days from published date
  When User is in the state law detail page
  Then user should able to view “New” tag for the article which has less than nor equal to15 days from published date in the state law detail page
#  @regression  @benefitsOfCannabis
...
#  Then user should should not able to view “New” tag for the article which has greater than 15 days from published date
  @regression @smoke @stateLawDetail_smoke_mob
Scenario: To verify user is able to view the Category tag as "Resources"  in the article section
    When User is in the state law detail page
    Then user should able to view the Category tag as "Resources"  in the article section of the state law detail page
...
Scenario: To verify that user should be able to view the big size (1192x606) image along with description
  When User is in the state law detail page
  Then user should be able to see the big size image in 1192x606 pixel in the state law detail page
