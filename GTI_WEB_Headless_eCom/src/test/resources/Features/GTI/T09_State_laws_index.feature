...
#        And user clicks on Yes in Age gate screen
    ...
    Scenario: To verify that user is redirected to state laws Page from from the global header
        And User clicks on Cannabis Insider from global header
        And User clicks on the state laws sub category
        When User clicks on the state laws sub category
        Then User lands on the the state laws page
#    @webRegression @mobRegression
#    Scenario: To  verify that User should be able to see appropriate breadcrumb
#        And User clicks on Cannabis Insider from global header
#        And User clicks on the state laws sub category
#        When User lands on the the state laws page
#        Then User should be able to see appropriate bredcrumb
    @webRegression @mobRegression @smoke
    Scenario: To verify that User should be able to view the main heading and  description for the page
        And User clicks on Cannabis Insider from global header
        And User clicks on the state laws sub category
        When User lands on the the state laws page
        Then User is able to view the main heading
        And User is able to view the main description
    @webRegression @mobRegression
...
#        And User clicks on Cannabis Insider from global header
#        And User clicks on the state laws sub category
#        When User is viewing the hero article of the state laws Page
...
#
#    @webRegression @mobRegression
#    Scenario: To verify that a user is able to see respective geolocated resources article for the state laws
#        And User clicks on Cannabis Insider from global header
#        And User clicks on the state laws sub category
#        When User lands on the the state laws page
#        Then user is able to view respective geolocated resources article for the state laws
#
    @webRegression @mobRegression @smoke
    Scenario: To verify that user should view the image associated with the article, title name, tags and Resources label, date in which it got published, brief about the article, Read more’ CTA
        And User clicks on Cannabis Insider from global header
        And User clicks on the state laws sub category
...
#        Then  user should not be able to view the Show more CTA
    ...
    @webRegression @mobRegression
    Scenario: To verify user is able to view the title, recommended resource name, short description of it, a Read more CTA in the recommended resources section of state laws page
        And User clicks on Cannabis Insider from global header
        And User clicks on the state laws sub category
        When User is able to see Recommended Resources located on the right side of page
